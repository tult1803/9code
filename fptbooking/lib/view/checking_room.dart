...
import 'package:fptbooking/presenter/add_services_persenter.dart';
import 'package:fptbooking/presenter/menu_item.dart';
import 'package:fptbooking/presenter/room_detail_presenter.dart';
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Column(
                                    children: [
                                      Image.asset('assets/images/image 3.png',height: 65,),
                                      Text("$status",
                                          style: TextStyle(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        Row(
                                          children: [
                                            Text("$room_name", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16)),
                                            Padding(
                                              padding: const EdgeInsets.only(left: 5),
                                              child: Text("$room_kind", style: TextStyle(fontWeight: FontWeight.w400, fontSize: 12, color: Color.fromARGB(255, 243, 117, 1))),),],
                                        ),
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Padding(
                                                padding: const EdgeInsets.only(left: 5),
                                                child: Text("$acreage m2", style: TextStyle(fontWeight: FontWeight.w400, fontSize: 12, color: Colors.grey)),),],
                                          ),
                                        ),
                                        Row(
                                          children: [
                                            ...
                                            Padding(
                                              padding: const EdgeInsets.only(left: 5),
                                              child: Text("$maximum_capacity", style: TextStyle(fontWeight: FontWeight.w400, fontSize: 12, color: Colors.grey)),),],
                                        ),
                                      ],
                                    ),
                                  ),
                    ...
                    child: Card(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Center(child: textTittle(tittle),),
                            text("Time"),
